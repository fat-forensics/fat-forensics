...
surrogate_explainers.SurrogateTabularExplainer.explain_instance`.
        ...
        if self.as_regressor:
            ...
            if explained_class is None:
                ...
                assert (explained_class_index is not None and
                        str(explained_class_index)), 'Explain a single class.'
                assert (explained_class_name is not None and
                        str(explained_class_name)), 'Explain a single class.'
